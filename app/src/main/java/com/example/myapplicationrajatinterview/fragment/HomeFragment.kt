...
package com.example.myapplicationrajatinterview.fragment
...
import com.example.myapplicationrajatinterview.OptiVideoEditor
import com.example.myapplicationrajatinterview.R
import com.example.myapplicationrajatinterview.`interface`.OptiFFMpegCallback
import com.example.myapplicationrajatinterview.`interface`.OptiVideoOptionListener
import com.example.myapplicationrajatinterview.adapter.OptiVideoOptionsAdapter
import com.example.myapplicationrajatinterview.utils.*
...
class HomeFragment : Fragment(), OptiBaseCreatorDialogFragment.CallBacks,
    OptiVideoOptionListener,
    OptiFFMpegCallback {

    private var tagName: String = HomeFragment::class.java.simpleName
